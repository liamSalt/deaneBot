...
def getDistros():
    ...
    for course in entries:
        ...
        complete = "**" + one + "**\n" + two +"\n" + three + "\n" + "https://www.qubirdhunter.com/?page_id=289" + ";"
        file.write(complete)
    file.close()
